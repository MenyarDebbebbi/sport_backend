...
const mealValidation = [
	...
	body('items').optional().isArray().withMessage('Les aliments doivent être un tableau'),
...
// Routes protégées
router.get('/admin/user/:userId?', authenticateToken, getUserMealsForCoach);

// Routes utilisateur (création/modif par coach uniquement)
router.post(
	'/',
	authenticateToken,
